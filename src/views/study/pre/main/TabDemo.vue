...
<script>
import TabNews from "@/views/study/pre/main/tabs/TabNews.vue";
import TabMusic from "@/views/study/pre/main/tabs/TabMusic.vue";
import TabMovie from "@/views/study/pre/main/tabs/TabMovie.vue";
